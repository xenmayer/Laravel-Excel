...
class ExcelWriterTest extends TestCase
{
    ...
    public function testNumberPrecision()
    {
        ...
        $this->assertTrue(is_float($results[4]['number']));
        $this->assertEquals((float) 1234, $results[4]['number']);

        $this->assertTrue(is_float($results[5]['number']));
        $this->assertEquals('1234.02', $results[5]['number']);

        $this->assertTrue(is_float($results[6]['number']));
        $this->assertEquals('0.0231231234423', $results[6]['number']);

        $this->assertTrue(is_float($results[7]['number']));
